...
- Mood Mark turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny one-page utility called Mood Mark. It should show a title, one text input for today's note, a save icon button, and a small saved status line. Keep it simple, responsive, and fully client-side.
...
- Record Operations - Mood Mark
- Record Editor - Mood Mark
- Insights - Mood Mark

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - Mood Mark
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - Mood Mark
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - Mood Mark
